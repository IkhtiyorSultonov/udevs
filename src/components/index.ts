...
export {default as SmsComponent} from './smsuz/smsuz'
export {default as GoodzoneComponent} from './goodzone/goodzone'
export {default as ImanComponent} from './iman/iman'
export {default as HowWork} from './howWork/howWork'
export {default as MapsComponents} from './maps/maps'